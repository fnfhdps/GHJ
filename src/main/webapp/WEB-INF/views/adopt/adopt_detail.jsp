	...
	<article>
	  <form method="post" id="adopt_form" action="/adopt/hope">
		...
		<div>
		 ...
		 <div>
            <!-- 프로필 이미지  -->
			<svg style="" width="5%" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
	  ...
	  <c:forEach items="${replyList}" var="reply">
		...
		<div>
			...
			<div>
				...
				<button type="button" class="update_content" style="vertical-align:middle; text-align:middle;" onclick="replyUpdate(${reply.replySeq},'#content_${reply.replySeq}');">입력</button> --%>
			</div>
		</div>
	  </c:forEach>
	</article>
